...
class AccountsQueryType extends ResponseQueryType {
    
    protected $modelName = '\App\Models\Accounts';

    protected $attributes = [
        'name' => 'AccountsQueryType',
    ...
    public function fields() {
        return [
            ...
            'GetAll' => [
                'type' => GraphQL::type("AccountsResponse"),
                'args' => [
                  'Accounts' => ['name' => 'Accounts', 'type' => GraphQL::type('AccountsInput')],
    ...
    public function resolveGetAllField($root, $args) {  
        ...
        if(isset($args['Accounts'])){
          $model = $model->where($args['Accounts']);
        }
