...
class UnitsInput extends UnitsType {
     ...
     */
     ...
     public function fields() {  
         parent::fields() ;
         $this->unsetFields(explode(',','attachments,rate,owner,Amenities,Rests,Views,Days,Bookings,Fees,FeeVat,DaysList,Promo,badges,cPolicy'));
