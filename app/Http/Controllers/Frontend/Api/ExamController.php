...
class ExamController extends ApiController
{
    ...
    public function index(){
        ...
        return $this->view('frontend.dashboard.exams.my-exams' , compact('myExams'));
    }
    ...
    public function myExam ($exam_id){
        ...
        return $this->view('frontend.dashboard.exams.my-exam' , ['examDetails' => $examContents['examDetails'], 'exam' => $examContents['examWithResults']]);
