...
trait PayfortRedirectRequest
{
     ...
     */
    public function displayTokenizationPage($data , $get = 0)
    {
        ...
        if( $get > 0 ){
           return  $this->getPayfortPage($requestParams);
        }
     ...
     * @return \Illuminate\View\View|\Illuminate\Contracts\View\Factory
     */
    public function displayRedirectionPage($data , $get = 0)
    {
        # Prepare redirection page request parameters
        $requestParams = [
    ...
    private function getPayfortPage($requestParams)
    {
        # Payfort redirect url
        $redirectUrl = $this->payfortEndpoint;
